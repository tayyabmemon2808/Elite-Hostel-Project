    ...
    <>
      <div className="landing-page">
              ...
              <div className="hostel-card" key={hostel._id}>
                ...
                <div className="hostel-card-body">
                  ...
                  <p className="hostel-price">
                    From Rs.{" "}
                    {Math.min(hostel.singleRoomPrice, hostel.sharedRoomPrice)}
                    /month
                  </p>
                  <Link
                    to={`/hostels/${hostel._id}`}
                    className="hostel-view-btn"
                  >
                    View Details
                  </Link>
                </div>
          ...
          <div className="reviews-grid">
            <div className="review-card">
              <p className="review-text">
                "Great place to stay, very clean rooms and helpful staff. Made
                my university life so much easier."
              </p>
              <p className="review-author">— Ayesha K.</p>
            </div>
            <div className="review-card">
              <p className="review-text">
                "Affordable and safe. The booking process was super smooth and
                quick."
              </p>
            ...
            <div className="review-card">
              <p className="review-text">
                "Best decision for my hostel stay. Highly recommend to fellow
                students."
              </p>
        ...
        <footer className="footer" id="footer-section">
          ...
          <p>
            © {new Date().getFullYear()} Elite Hostels. All Rights Reserved.
          </p>
        </footer>
      </div>
    </>
